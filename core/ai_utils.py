...
def generate_smart_summary(file_path):
    ...
    prompt = f"""
        אתה עוזר אקדמי חכם של סטודנטים. עליך לקרוא את הטקסט הבא מתוך קובץ לימודי ולהכין לו תקציר ממוקד, קצר וברור בעברית.
        הוראות עיצוב חובה:
        1. השתמש בנקודות (Bullet points) כדי לסדר את המידע.
        2. אל תשתמש בסימני כוכביות (** או *) בשום צורה. כתוב טקסט נקי וקריא.
        3. חלץ רק את שורות התחתונות והמידע הקריטי ביותר.
